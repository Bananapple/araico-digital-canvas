  ...
  return (
    <div className="min-h-screen overflow-hidden bg-background relative">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute top-1/3 right-1/4 w-80 h-80 bg-amber-500/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute bottom-1/4 left-1/3 w-72 h-72 bg-orange-400/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
