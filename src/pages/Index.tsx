    ...
    <div className="min-h-screen overflow-hidden bg-background relative">
      ...
      <div className="h-screen flex items-center justify-center relative">
        ...
        <div className="absolute inset-0 -z-10">
          <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-orange-500 rounded-full"></div>
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-orange-400 rounded-full"></div>
        </div>
      </div>
